...
namespace Identity.jwt.Providers
{
    public class CustomOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        public override Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            identity.AddClaim(new System.Security.Claims.Claim(System.Security.Claims.ClaimTypes.Role, "Manager"));
            identity.AddClaim(new System.Security.Claims.Claim(System.Security.Claims.ClaimTypes.Role, "Supervisor"));
